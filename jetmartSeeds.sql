...
("Yamaha Electric Piano", "Musical Instruments", 669.99, 4),    /* Comma after ) here */
("Bedding Sheets Set Queen Size", "Household", 118.95, 20),     /* Comma after ) here */
("Contemporary Sofa", "Furniture", 370.44, 4),                  /* Comma after ) here */
("Kitchen Aid Stand Mixer", "Home & Kitchen", 279.99, 4),       /* Comma after ) here */
